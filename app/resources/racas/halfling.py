...
class Halfling(Raca):
    def __init__(self):
        ...
        self.description = "Os pequeninos halflings sobrevivem em um mundo cheio de criaturas maiores ao evitar " \
                           ...
                           "Eles gostam de usar roupas simples, confortáveis e práticas, preferindo as cores claras. " \
                           "A praticidade dos halflings se estende para além de suas roupas. Eles se preocupam com " \
                           "as necessidades básicas e os prazeres simples, e não são inclinados à ostentação. Mesmo " \
                           "o mais rico dos halflings mantém seus tesouros trancados em um porão, em vez de expostos " \
                           "à vista de todos. Eles possuem um talento especial para encontrar a solução mais simples " \
                           "para um problema e têm pouca paciência para indecisões. "
        self.restrictions = []
        self.skills = [
            ...
            "maior que o seu. ",
            "Idiomas. Você pode falar, ler e escrever Comum e Halfling. A linguagem Halfling não é secreta, mas os "
            "halflings são relutantes em compartilhá-la com os outros. Eles escrevem muito pouco, por isso eles não "
            "possuem uma literatura rica. No entanto, sua tradição oral é muito forte. Quase todos os halflings falam "
            "o idioma Comum para conversar com as pessoas das terras que habitam, ou através das quais eles estejam "
            "viajando. "
        ]
        self.magic = {}
        self.stats = {
    ...
    def __set_constituition__(self, constituition):
        self.stats["constituition"] = constituition
