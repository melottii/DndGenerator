...
class HalflingPesLeves(Halfling):
    def __init__(self):
        ...
        self.__add_skill__("Furtividade Natural", "Você pode tentar se esconder mesmo quando possuir apenas a cobertura de uma criatura que for no mínimo um tamanho maior que o seu.")
