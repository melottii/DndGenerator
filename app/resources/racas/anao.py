...
class Anao(Raca):
    def __init__(self):
        super().__init__()
        self.name = "Anão"
        self.description = "Audazes e resistentes, os anões são conhecidos como hábeis guerreiros, " \
                           "mineradores e " \
        ...
        self.skills = ["Aumento no Valor de Habilidade. Seu valor de Constituição aumenta em 2.",
                       "Idade. Anões tornam-se maduros na mesma proporção que os humanos, mas são "
                       "considerados jovens até atingirem a idade de 50 anos. Em média, eles vivem "
                       "350 anos.", "Tendência. A maioria dos anões é leal, pois acreditam firmemente nos benefícios "
                                    "de uma sociedade bem organizada. Eles tendem para o bem, com um forte senso "
                                    "de honestidade e uma crença de que todos merecem compartilhar os benefícios de "
                                    "uma ordem social justa.",
                       "Tamanho. Anões estão entre 1,20 e 1,50 metro de altura e pesam cerca de 75 kg. "
                       "Seu tamanho é Médio.", "Deslocamento. Seu deslocamento base de caminhada é de 7,5 metros. Seu "
                       ...
                       "Resiliência Anã. Você possui vantagem em testes de resistência contra venenos "
                       "e resistência contra dano de veneno.",
        ...
        self.magic = {}
        self.stats = {"strength": 0, "dexterity": 0, "constituition": 2, "intelligence": 0, "wisdom": 0,
                      "charisma": 0, }
