...
class Equipamentos:
    def __init__(self):
        self.pacotes = {
            "Pacote de Artista": {
                "preco": 40,
                "moeda": "po",
                "descricao": "Inclui uma mochila , um saco de dormir, duas fantasias, 5 velas, "
                                    "5 dias de rações, um cantil e um kit de disfarce.",
                "itens": [("Mochila", 1), ("Saco de dormir", 1), ("Fantasia", 2), ("Rações de viagem (1 dia)", 5), ("Cantil", 1), ("Kit de disfarce", 1)],
            },
            
            "Pacote de Assaltante": {
                "preco": 16,
                "moeda": "po",
                "descricao": "Inclui uma mochila, um saco com 1.000 esferas de metal, 3 "
                                    ...
                                    "dele.",
                "itens": [("Mochila", 1), ("Esferas (sacola com 1.000)", 1), ("Linha (1 metro)", 3), ("Sino", 1), ("Vela", 5), ("Pé de cabra", 1),
                            ("Martelo", 1), ("Píton", 10), ("Lanterna coberta", 1), ("Óleo (frasco)", 2), ("Rações de viagem (1 dia)", 5),
                            ("Caixa de fogo", 1), ("Cantil", 1), ("Corda de cânhamo (15 metros)", 1)]
            },

            "Pacote de Aventureiro": {
                "preco": 12,
                "moeda": "po",
                "descricao": "Inclui uma mochila, um pé de cabra, um martelo, 10 pítons, "
                                    "10 tochas, uma caixa de fogo, 10 dias de rações e um cantil."
                                    " O kit também tem 15 metros de corda de cânhamo amarrada ao"
                                    " lado dele.",
                "itens": [("Mochila", 1), ("Pé de cabra", 1), ("Píton", 10), ("Tocha", 10), ("Caixa de fogo", 1), ("Rações de viagem (1 dia)", 10),
            ...
            "Pacote de Diplomata": {
                "preco": 39,
                "moeda": "po",
                "descricao": "Inclui um baú, 2 caixas para mapas ou pergaminhos, um conjunto"
                ...
                "itens": [("Baú", 1), ("Caixa para mapa ou pergaminho", 2), ("Roupas finas", 1), ("Tinta (frasco de 30ml)", 1), ("Caneta tinteiro", 1),
                            ("Lâmpada", 1), ("Óleo (frasco)", 2), ("Papel (uma folha)", 5), ("Perfume (frasco)", 1), ("Parafina", 1), ("Sabão", 1)]
            },

            "Pacote de Estudioso": {
                "preco": 40,
                "moeda": "po",
                "descricao":"Inclui uma mochila, um livro de estudo, um vidro de tinta, uma"
                                    " caneta tinteiro, 10 folhas de pergaminho, um saquinho de "
                                    "areia e uma pequena faca.",
                "itens": [("Mochila", 1), ("Livro", 1), ("Tinta (frasco de 30ml)", 1), ("Caneta tinteiro", 1), ("Pergaminho (uma folha)", 10),
                            ("Saco", 1), ("Faca", 1)]
            },
            ...
            "Pacote de Explorador": {
                "preco": 10,
                "moeda": "po",
                "descricao": "Inclui uma mochila, um saco de dormir, um kit de refeição, "
                                    "uma caixa de fogo, 10 tochas, 10 dias de rações e um cantil."
                                    " O kit também tem 15 metros de corda de cânhamo amarrada ao "
                                    "lado dele.",
                "itens": [("Mochila", 1), ("Saco de dormir", 1), ("Kit de refeição", 1), ("Caixa de fogo", 1), ("Tocha", 10), ("Rações de viagem (1 dia)", 10),
            ...
            "Pacote de Sacerdote": {
                "preco": 19,
                "moeda": "po",
                "descricao": "Inclui uma mochila, um cobertor, 10 velas, uma caixa de fogo, "
                                    "uma caixa de esmolas, 2 blocos de incenso, um incensário, "
                                    "vestes, 2 dias de rações e um cantil.",
                "itens": [("Mochila", 1), ("Cobertor de inverno", 1), ("Vela", 10), ("Caixa de fogo", 1), ("Caixa de esmola", 1), ("Bloco de incenso", 2),
                            ("Incensário", 1), ("Roupas comuns ", 1), ("Rações de viagem (1 dia)", 2), ("Cantil", 1)]
            }
        }
    ...
    def __clone_pacote__(self, pacote_dict):
        ...
        for pacote in pacote_dict:
            ...
            pacote_obj = Pacote(
                pacote,
                pacote_dict[pacote]["preco"],
                pacote_dict[pacote]["moeda"],
                itens
            )
            return pacote_obj
    
    def __clone_equipamento__(self, equipamento_dict, quant=1):
        for equipamento in equipamento_dict:
            equipamento_obj = Equipamento(
                equipamento,
                equipamento_dict[equipamento]["preco"],
                equipamento_dict[equipamento]["moeda"],
                equipamento_dict[equipamento]["peso"],
                quant
            )
