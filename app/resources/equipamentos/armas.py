...
class Armas:
    def __init__(self):
        self.corpo_a_corpo_simples = {"Adaga": {"preco": 2, "moeda": "po", "dano": "1d4", "peso": "0.5 kg",
        ...
        self.distancia_simples = {"Arco Curto": {"preco": 25, "moeda": "po", "dano": "1d6", "peso": "1 kg",
        ...
        self.corpo_a_corpo_marcial = {"Alabarda": {"preco": 20, "moeda": "po", "dano": "1d10", "peso": "3 kg",
                                      ...
                                      "Machado de Batalha": {"preco": 10, "moeda": "po", "dano": "1d8",
                                                             "peso": "3.5 kg", "propriedades": ["Cortante", "Leve"]},
        ...
        self.distancia_marcial = {"Arco Longo": {"preco": 50, "moeda": "po", "dano": "1d8", "peso": "1 kg",
    ...
    def __get_distancia_marcial__(self, param):
        return {param: self.distancia_marcial[param]}
    ...
    @staticmethod
    def __clone_arma__(arma_dict):
        for arma in arma_dict:
            arma_obj = Arma(arma, arma_dict[arma]["preco"], arma_dict[arma]["moeda"], arma_dict[arma]["peso"], 1,
                            arma_dict[arma]["dano"], arma_dict[arma]["propriedades"])
            return arma_obj
